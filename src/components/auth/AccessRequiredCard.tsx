    ...
    return (
      <main className="mx-auto max-w-2xl px-4 py-12">
        <div className="rounded-2xl border border-amber-200 bg-amber-50 p-6">
          <h1 className="text-xl font-semibold text-amber-900">메일 인증이 완료되어야 이용할 수 있습니다.</h1>
          <p className="mt-2 text-sm text-amber-800">
            인증 후 자동으로 원래 페이지로 돌아갑니다.
          </p>
          <div className="mt-4">
            <Link
              href={`/verify-email?next=${encodeURIComponent(next)}`}
  ...
  return (
    <main className="mx-auto max-w-2xl px-4 py-12">
      <div className="rounded-2xl border border-zinc-200 bg-white p-6">
        <h1 className="text-xl font-semibold text-zinc-900">이 기능은 로그인 후 이용할 수 있습니다.</h1>
        <p className="mt-2 text-sm text-zinc-600">로그인 후 자동으로 원래 페이지로 돌아갑니다.</p>
        <div className="mt-4">
          <Link
