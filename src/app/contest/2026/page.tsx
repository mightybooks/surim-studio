...
export default async function Contest2026Page() {
  ...
  return (
    ...
    <div className="rounded-2xl p-6 bg-indigo-100/70 border-indigo-200">
      ...
      <p>
        본 대회는 상업적 계약 관계를 전제로 하지 않으며, 상금 규모는 소정입니다.</p>

      <h3 className="mt-8 mb-2 text-base font-semibold text-neutral-900">원고 취급 및 저작권</h3>
      <p>
        응모작의 저작권은 응모자에게 귀속됩니다. 주최 측은 수상작에 한하여 『월간 수림지』 창간호에 수록할 수 있는 권리를 가집니다.</p>
      <p>
        수상 이후, 응모자는 해당 원고를 자유롭게 다른 매체·출판물·공모전에 활용할 수 있습니다. 
        단, 타 공모전의 신작 인정 여부는 각 주최 측의 규정에 따르며, 이에 대해 주최 측은 책임지지 않습니다.</p>

      <h3 className="mt-8 mb-2 text-base font-semibold text-neutral-900">응모 가능 및 제한 기준</h3>
      <ul className="list-disc pl-5 space-y-1">
        <li>
          개인 블로그, 브런치, SNS 등 웹에 공개했던 원고를 수정·보완하여 응모하는 경우</li>
        <li>
          AI 도구를 오탈자 점검, 맞춤법 교정 등 보조적 용도로 제한적으로 사용한 경우</li>
      </ul>

      <p>다음의 경우는 응모 불가</p>
      <ul className="list-disc pl-5 space-y-1">
        <li>
          이미 지면(종이책·전자책·잡지 등)에 발표된 원고</li>
        <li>
          AI가 서사 구성, 문단 생성, 대량 문장 생산 등 창작의 핵심 과정에 실질적으로 관여한 것으로 판단되는 원고</li>
        <li>
          AI 사용 여부 및 범위에 대한 판단은 주최 측의 판단에 따르며, 해당 원고는 별도의 고지 없이 심사 대상에서 제외될 수 있습니다.</li>
      </ul>    

      <h3 className="mt-8 mb-2 text-base font-semibold text-neutral-900">심사 및 발표</h3>
      <p>
        심사는 내부 심사 기준에 따라 진행되며, 결과는 2026년 3월 이후 발표 예정입니다. 수상작은 『월간 수림지』 창간호에 수록됩니다.</p>
      <p>
        본 요강에 명시되지 않은 사항은 주최 측의 판단에 따라 결정됩니다.
        <br />
        문의: <strong>surimstudio@gmail.com</strong></p>
      </div>
      </section>
