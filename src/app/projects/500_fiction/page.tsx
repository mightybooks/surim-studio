// src/app/projects/500_fiction/page.tsx
...
export const metadata: Metadata = {
  ...
  description:
    "초단편 500자 서사 실험. 101편 연재와 문체 이론 정리, 단행본 출간.",
  alternates: {
    canonical: "/projects/500_fiction",
  },
  openGraph: {
    title: "500자소설 프로젝트 – 수림 스튜디오",
    description:
      "초단편 500자 서사 실험. 101편 연재와 문체 이론 정리, 단행본 발간까지의 여정.",
    images: ["/covers/500_fiction_hero.webp"],
    type: "article",
    locale: "ko_KR",
  },
};

export default function ficionnovel500ProjectPage() {
  return (
    <main className="max-w-4xl mx-auto px-6 py-12 space-y-16">
      ...
      <article className="prose prose-zinc max-w-none news-body">
        ...
        <ul>
          ...
          <li>대중을 위해 어려운 단어나 배경 지식이 없어도 직관적으로 이해가 될 법한 이야기를 우선적으로 쓴다.</li>
        ...
        <ul>
          ...
          <li>앱을 통해 독자들도 500자 쓰기에 도전하고, AI 수림봇을 통해 실시간으로 문수림의 작품들과 어떤 면에서 차이가 나는지 평가 받을 수 있다.</li>
