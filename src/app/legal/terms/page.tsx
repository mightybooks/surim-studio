...
export const metadata: Metadata = {
  title: "이용약관 | 수림 스튜디오",
  description:
    "수림 스튜디오 서비스 이용약관입니다. 회원 가입 및 서비스 이용과 관련한 권리와 의무를 규정합니다.",
  robots: {
    index: true,
    follow: true,
  },
...
export default function TermsPage() {
  return (
    ...
    <section id="article-1">
        ...
        <p>이 약관은 ‘마이티북스’(전자상거래 사업자)가 운영하는 ‘수림 스튜디오’ 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.</p>
    </section>

    <section id="article-2">
        <h2 className="font-semibold">제2조 정의</h2>
        <p>① “몰”이란 마이티북스가 재화를 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.</p>
        <p>② “이용자”란 “몰”에 접속하여 이 약관에 따라 “몰”이 제공하는 서비스를 받는 회원과 비회원 모두를 말합니다.</p>
    ...
    <section id="article-3">
        ...
        <p>① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호, 모사전송번호, 전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 수림 스튜디오 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.</p>
    ...
    <section id="article-4">
        ...
        <p>① “몰”은 다음과 같은 업무를 수행합니다.</p>
          <ul className="list-disc pl-5 space-y-1">
            <li>1. 재화 또는 디지털 콘텐츠에 대한 정보 제공 및 구매계약의 체결</li>
            <li>2. 구매계약이 체결된 재화 또는 디지털 콘텐츠의 배송</li>
            <li>3. 기타 “몰”이 정하는 업무</li>
          </ul>
        <p>② “몰”은 재화 또는 디지털 콘텐츠의 품절 또는 기술적 사양의 변경 등의 경우에는 장차 체결되는 계약에 의해 제공할 재화 또는 디지털 콘텐츠의 내용을 변경할 수 있습니다. 이 경우에는 변경된 재화 또는 디지털 콘텐츠의 내용 및 제공일자를 명시하여 현재의 재화 또는 디지털 콘텐츠의 내용을 게시한 곳에 즉시 공지합니다.</p>
    ...
    <section id="article-6">
        ...
        <p>⑤ 본 서비스는 만 14세 이상 이용자만을 대상으로 합니다. 만 14세 미만 아동은 본 서비스에 가입하거나 이용할 수 없으며, 이용자는 회원가입 및 서비스 이용 시 본인이 만 14세 이상임을 확인하고 이에 동의합니다.</p>
    </section>
    ...
    <section id="article-9">
        ...
        <ul className="list-disc pl-5 space-y-1">
            <li>1. 재화 또는 디지털 콘텐츠 등의 구매 등의 검색 및 선택</li>
            ...
            <li>5. 재화 또는 디지털 콘텐츠 등의 구매 등의 구매신청 및 이에 관한 확인 또는 “몰”의 확인에 대한 동의</li>
            <li>6. 결제방법의 선택</li>
        </ul>
    ...
    <section id="article-10">
        ...
        <ul className="list-disc pl-5 space-y-1">
            ...
            <li>2. 미성년자가 담배, 주류 등 청소년보호법에서 금지하는 재화 및 디지털 콘텐츠를 구매하는 경우</li>
    ...
    <section id="article-11">
        <h2 className="font-semibold">제11조 지급방법</h2>
        <p>“몰”에서 구매한 재화 또는 디지털 콘텐츠에 대한 대금지급방법은 다음 각 호의 방법중 가용한 방법으로 할 수 있습니다. 단, “몰”은 이용자의 지급방법에 대하여 재화 등의 대금에 어떠한 명목의 수수료도  추가하여 징수할 수 없습니다.</p>          
        <ul className="list-disc pl-5 space-y-1">
    ...
    <section id="article-13">
        ...
        <p>① “몰”은 이용자와 재화 또는 디지털 콘텐츠 등의 공급시기에 관하여 별도의 약정이 없는 이상, 이용자가 청약을 한 날부터 7일 이내에 재화 등을 배송할 수 있도록 주문제작, 포장 등 기타의 필요한 조치를 취합니다. 이때, 디지털 콘텐츠의 경우 즉시 제공합니다. 다만, “몰”이 이미 재화 또는 디지털 콘텐츠 등의 대금의 전부 또는 일부를 받은 경우에는 대금의 전부 또는 일부를 받은 날부터 3영업일 이내에 조치를 취합니다. 이때 “몰”은 이용자가 재화 등의 공급 절차 및 진행 사항을 확인할 수 있도록 적절한 조치를 합니다.</p>          
    ...
    <section id="article-14">
        <h2 className="font-semibold">제14조 환급</h2>
    ...
    <section id="article-15">
        <h2 className="font-semibold">제15조 청약철회 등</h2>
        ...
        <p>③ 제2항 제2호 내지 제4호의 경우에 “몰”이 사전에 청약철회 등이 제한되는 사실을 소비자가 쉽게 알 수 있는 곳에 명기하거나 시용상품을 제공하는 등의 조치를 하지 않았다면 이용자의 청약철회 등이 제한되지 않습니다.</p>                
    ...
    <section id="article-16">
        <h2 className="font-semibold">제16조 청약철회 등의 효과</h2>
    ...
    <section id="article-17">
        <h2 className="font-semibold">제17조 개인정보보호</h2>
    ...
    <section id="article-18">
        <h2 className="font-semibold">제18조 “몰”의 의무</h2>
        <p>① “몰”은 법령과 이 약관이 금지하거나 공서양속에 반하는 행위를 하지 않으며 이 약관이 정하는 바에 따라 지속적이고, 안정적으로 재화․디지털 콘텐츠를 제공하는데 최선을 다하여야 합니다.</p>          
        <p>② “몰”은 이용자가 안전하게 인터넷 서비스를 이용할 수 있도록 이용자의 개인정보(신용정보 포함)보호를 위한 보안 시스템을 갖추어야 합니다.</p>       
        <p>③ “몰”이 상품이나 디지털 콘텐츠에 대하여 「표시․광고의 공정화에 관한 법률」 제3조 소정의 부당한 표시․광고행위를 함으로써 이용자가 손해를 입은 때에는 이를 배상할 책임을 집니다.</p>                
        <p>④ “몰”은 이용자가 원하지 않는 영리목적의 광고성 전자우편을 발송하지 않습니다.</p>                
    </section>

    <section id="article-19">
        <h2 className="font-semibold">제19조 회원의 ID 및 비밀번호에 대한 의무</h2>
    ...
    <section id="article-20">
        <h2 className="font-semibold">제20조 이용자의 의무</h2>
    ...
    <section id="article-21">
        <h2 className="font-semibold">제21조 연결“몰”과 피연결“몰” 간의 관계</h2>
    ...
    <section id="article-22">
        <h2 className="font-semibold">제22조 저작권의 귀속 및 이용제한</h2>
    ...
    <section id="article-23">
        <h2 className="font-semibold">제23조 분쟁해결</h2>
    ...
    <section id="article-24">
        <h2 className="font-semibold">제24조 재판권 및 준거법</h2>
