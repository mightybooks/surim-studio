...
const PRODUCT_CATALOG: EditionProduct[] = [
  ...
  {
    id: "digital-500-fiction",
    slug: "500-fiction-digital",
    section: "surimseoga",
    name: "500자 소설 디지털판",
    type: "DIGITAL",
    category: "surimseoga",
    summary: "500자 소설 디지털 플립북",
    price: 6800,
    priceUsd: 5.5,
    thumbnail: "/productlist/500ficion_list.webp",
    detailImage: "/productdetail/500ficion_detail.webp",
    composition: "디지털 플립북 이용권",
    spec: "웹 전용 / 209페이지",
  },
  {
    id: "goods-8cut-7set",
...
const SECTION_TARGETS: Record<EditionSection, ProductTarget[]> = {
  surimseoga: [
    ...
    {
      ids: ["digital-500-fiction"],
      slugs: ["500-fiction-digital"],
      name: "500자 소설 디지털판",
      categories: ["surimseoga", "digital"],
    },
  ],
  goods: [
    {
